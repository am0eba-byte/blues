...
nounBar_chartOver10.title = 'Nouns Used Over 10 Times in Song Lyrics from the 2000s'
nounBar_chartTopTen.title = 'Top 10 Nouns in Songs from the 2000s'
...
nounBar_chartOver10.render_to_file('00sNOUNbar_Over10.svg')
nounBar_chartTopTen.render_to_file('00sNOUNbar_TopTen.svg')
...
bar_chartOver10.title = 'Verbs Used Over 10 Times in Song Lyrics from 2000s'
bar_chartTopTen.title='Top 10 Verbs in Songs from 2000s'
...
bar_chartOver10.render_to_file('00sVERBbar_chartOver10.svg')
bar_chartTopTen.render_to_file('00sVERBbar_chartTopTen.svg')
