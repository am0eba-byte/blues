...
seventies = open("rawText/seventiesLyricsNLP.txt", "r")

words = seventies.read()
seventiesWords = nlp(words)
...
print("TOP TEN NOUNS:")
listNouns = nouncollector(seventiesWords)
...
nounBar_chartOver10.title = 'Nouns Used Over 10 Times in Song Lyrics from the 1970s'
nounBar_chartTopTen.title = 'Top 10 Nouns in Songs from the 1970s'
...
nounBar_chartOver10.render_to_file('70sNOUNbar_Over10.svg')
nounBar_chartTopTen.render_to_file('70sNOUNbar_TopTen.svg')
...
print("TOP TEN VERBS:")
listVerbs = verbcollector(seventiesWords)
...
bar_chartOver10.title = 'Verbs Used Over 10 Times in Song Lyrics from 1970s'
bar_chartTopTen.title='Top 10 Verbs in Songs from 1970s'
...
bar_chartOver10.render_to_file('70sVERBbar_chartOver10.svg')
bar_chartTopTen.render_to_file('70sVERBbar_chartTopTen.svg')
