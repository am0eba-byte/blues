...
fifties = open("rawText/fiftiesLyricsNLP.txt", "r")

words = fifties.read()
fiftiesWords = nlp(words)
...
print("TOP TEN NOUNS:")
listNouns = nouncollector(fiftiesWords)
...
nounBar_chartOver10.title = 'Nouns Used Over 10 Times in Song Lyrics from the 1950s'
nounBar_chartTopTen.title = 'Top 10 Nouns in Songs from the 1950s'
...
nounBar_chartOver10.render_to_file('50sNOUNbar_Over10.svg')
nounBar_chartTopTen.render_to_file('50sNOUNbar_TopTen.svg')
...
print("TOP TEN VERBS:")
listVerbs = verbcollector(fiftiesWords)
...
bar_chartOver10.title = 'Verbs Used Over 10 Times in Song Lyrics from 1950s'
bar_chartTopTen.title='Top 10 Verbs in Songs from 1950s'
...
bar_chartOver10.render_to_file('50sVERBbar_chartOver10.svg')
bar_chartTopTen.render_to_file('50sVERBbar_chartTopTen.svg')
