...
eighties = open("rawText/eightiesLyricsNLP.txt", "r")

words = eighties.read()
eightiesWords = nlp(words)
...
print("TOP TEN NOUNS:")
listNouns = nouncollector(eightiesWords)
...
nounBar_chartOver10.title = 'Nouns Used Over 10 Times in Song Lyrics from the 1980s'
nounBar_chartTopTen.title = 'Top 10 Nouns in Songs from the 1980s'
...
nounBar_chartOver10.render_to_file('80sNOUNbar_Over10.svg')
nounBar_chartTopTen.render_to_file('80sNOUNbar_TopTen.svg')
...
print("TOP TEN VERBS:")
listVerbs = verbcollector(eightiesWords)
...
bar_chartOver10.title = 'Verbs Used Over 10 Times in Song Lyrics from 1980s'
bar_chartTopTen.title='Top 10 Verbs in Songs from 1980s'
...
bar_chartOver10.render_to_file('80sVERBbar_chartOver10.svg')
bar_chartTopTen.render_to_file('80sVERBbar_chartTopTen.svg')
