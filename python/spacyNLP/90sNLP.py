...
nineties = open("rawText/ninetiesLyricsNLP.txt", "r")
...
print("TOP TEN NOUNS:")
listNouns = nouncollector(ninetiesWords)
...
nounBar_chartOver10.title = 'Nouns Used Over 10 Times in Song Lyrics from the 1990s'
nounBar_chartTopTen.title = 'Top 10 Nouns in Songs from the 1990s'
...
nounBar_chartOver10.render_to_file('90sNOUNbar_Over10.svg')
nounBar_chartTopTen.render_to_file('90sNOUNbar_TopTen.svg')
...
print("TOP TEN VERBS:")
listVerbs = verbcollector(ninetiesWords)
...
bar_chartOver10.title = 'Verbs Used Over 10 Times in Song Lyrics from 1990s'
bar_chartTopTen.title='Top 10 Verbs in Songs from 1990s'
...
bar_chartOver10.render_to_file('90sVERBbar_chartOver10.svg')
bar_chartTopTen.render_to_file('90sVERBbar_chartTopTen.svg')
