...
fourties = open("rawText/fourtiesLyricsNLP.txt", "r")

words = fourties.read()
fourtiesWords = nlp(words)
...
print("TOP TEN NOUNS:")
listNouns = nouncollector(fourtiesWords)
...
nounBar_chartOver10.title = 'Nouns Used Over 10 Times in Song Lyrics from the 1940s'
nounBar_chartTopTen.title = 'Top 10 Nouns in Songs from the 1940s'
...
nounBar_chartOver10.render_to_file('40sNOUNbar_Over10.svg')
nounBar_chartTopTen.render_to_file('40sNOUNbar_TopTen.svg')
...
print("TOP TEN VERBS:")
listVerbs = verbcollector(fourtiesWords)
...
bar_chartOver10.title = 'Verbs Used Over 10 Times in Song Lyrics from 1940s'
bar_chartTopTen.title='Top 10 Verbs in Songs from 1940s'
...
bar_chartOver10.render_to_file('40sVERBbar_chartOver10.svg')
bar_chartTopTen.render_to_file('40sVERBbar_chartTopTen.svg')
